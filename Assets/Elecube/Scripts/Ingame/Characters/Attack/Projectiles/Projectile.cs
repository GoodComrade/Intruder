...
public abstract class Projectile : NetworkBehaviour, IPredictedSpawnBehaviour
{
    ...
    public abstract void InitNetworkState(Vector3 ownerVelocity, IntruderCharacterController intruderCharacter, Vector3 aimTarget);
    ...
    {
        Debug.LogWarning(
            $"Predicted Spawn Failed Object={Object.Id}, instance={gameObject.GetInstanceID()}, resim={Runner.IsResimulation}");
